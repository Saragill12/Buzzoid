...
>
  ...
  <g>
    <path
      fill="url(#linear-gradient-colors)"
    ...
    />
    <path
      fill="url(#linear-gradient-colors-2)"
    ...
    />
    <circle
      fill="url(#linear-gradient-colors-3)"
      cx="418.306"
      cy="134.072"
      r="34.149"
    />

...
export default function InstagramFollowersPage() {
  ...
  return (
    <div
      className="relative bg-gradient-to-b from-[#e0f2ff] to-white p-6 md:p-8 rounded-2xl shadow-xl w-[70%] mx-auto
        overflow-hidden [&::after]:content-[''] [&::after]:absolute [&::after]:bottom-[-40px] [&::after]:left-0
        [&::after]:w-full [&::after]:h-32 [&::after]:bg-white [&::after]:blur-3xl [&::after]:z-[-1]"
    >
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">

        {/* Card 1 */}
        <Card className="bg-white/90 backdrop-blur-sm w-[70%] min-h-[470px] ml-3 border border-gray-300 rounded-2xl shadow-sm flex flex-col">
        ...
        <Card className="bg-white/90 backdrop-blur-sm w-full sm:w-[90%] md:w-[80%] lg:w-[70%] min-h-[470px] rounded-2xl shadow-sm border border-gray-300 flex flex-col lg:-ml-24 mx-auto">
        ...
        {/* Right Column */}
<div className="p-6 flex flex-col justify-between min-h-[470px] mx-auto lg:ml-[-10%]">
          <div>

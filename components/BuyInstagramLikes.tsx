...
export default function InstagramFollowersPage() {
  ...
  return (
    <div
      className="relative bg-gradient-to-b from-[#e0f2ff] to-white p-6 md:p-8 rounded-2xl mt-10 shadow-xl w-[70%] mx-auto
    ...
    >
      <div className="grid grid-cols-1  lg:grid-cols-3 gap-6">
        ...
        {/* Column 1: Buy Instagram Followers */}
        <div className="p-6 flex flex-col justify-between min-h-[470px] ">
          <div>
        ...
        <Card className="bg-white/90 backdrop-blur-sm w-[70%] min-h-[470px] ml-40 border border-gray-300 rounded-2xl shadow-sm flex flex-col">
        ...
        <Card className="bg-white/90 backdrop-blur-sm w-[70%] min-h-[470px] ml-20 rounded-2xl shadow-sm border border-gray-300 flex flex-col">
          <CardContent className="p-6 text-center flex flex-col h-full">
            <img
